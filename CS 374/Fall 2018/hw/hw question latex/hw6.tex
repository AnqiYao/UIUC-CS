...
\headers{CS/ECE 374}{Homework 6 (due October 24)}{Fall 2018}
...
\item Given a graph $G=(V,E)$ a matching is a subset of edges in $G$
  ...
  \begin{figure}[h]
    \centering
    \includegraphics[width=4in]{Fig/matching-in-trees}
