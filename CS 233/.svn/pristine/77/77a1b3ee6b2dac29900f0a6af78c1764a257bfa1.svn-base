...
alu1 a31 (out[31], carryout[31], A[31], B[31], carryout[30], control);
    ...
    assign overflow = ((out[31]==1 && control==3'b010 && A[31]==0 && B[31]==0) || ( A[31]==1 && B[31]==1 && control == 3'b010 && out[31] == 0) || (out[31]==1 && control==3'b011 && A[31]==0 && B[31]==1) || ( A[31]==1 && B[31]==0 && control == 3'b011 && out[31] ==0));
